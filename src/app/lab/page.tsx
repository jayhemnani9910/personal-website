    ...
    building: [
        {
            id: "website-v3",
            title: "Portfolio V3",
            description: "This website - visual demo pages, animated components, AI-powered features",
    ...
    exploring: [
        {
            ...
            description: "LangChain agents, RAG systems, semantic caching patterns",
            tags: ["LangChain", "OpenAI", "Redis Vector"]
        },
        {
            id: "distributed-patterns",
            title: "Distributed System Patterns",
            description: "Event sourcing, CQRS, saga patterns with Kafka",
            tags: ["Kafka", "Event-Driven", "Microservices"]
        },
        {
            id: "edge-computing",
            title: "Edge AI",
            description: "Running ML models in browser with ONNX and WebGPU",
    ...
    radar: [
        {
            ...
            description: "Building custom AI agents with Anthropic's new SDK",
            tags: ["Anthropic", "Agents"]
        },
        {
            id: "local-llm",
            title: "Local LLM Tooling",
            description: "Ollama, llama.cpp, private document search",
            tags: ["Ollama", "Privacy-First"]
        },
        {
            id: "realtime-collab",
            title: "Real-time Collaboration",
            description: "CRDTs, operational transforms, multiplayer patterns",
