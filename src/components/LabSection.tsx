...
import { FlaskConical, Terminal, Cpu } from "lucide-react";
...
export function LabSection() {
    return (
        <section className="relative section-block section-shell">
            <motion.div
                ...
                {EXPERIMENTS.map((exp, i) => (
                    ...
                    >
                        <div className="flex justify-between items-start mb-4">
                            <exp.icon className="w-6 h-6 text-[var(--text-muted)] group-hover:text-[var(--neon-purple)] transition-colors" />
