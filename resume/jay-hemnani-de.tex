...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{\textbf{Coursework:} Database Systems, Big Data Analytics, Operating Systems, Computer Networks.}
      \resumeItemListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.12in, label={}]
    \small{\item{
     \textbf{Programming:} Python, SQL, Java, Go, JavaScript/TypeScript \\
     \textbf{Data Engineering:} Apache Kafka, Apache Airflow, PySpark, Pandas, ETL/ELT Pipelines, dbt, Data Modeling \\
     ...
     \textbf{Tools:} Tableau, Power BI, Streamlit, Dash, Git, GitHub Actions (CI/CD), Prometheus
    }}
 \end{itemize}
 \vspace{-8pt}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeExpHeading
      ...
      {}{}
      \resumeItemListStart
        \resumeItem{Provided \textbf{data analytics and pipeline consulting} for small businesses, building reporting automation, ETL workflows, and data infrastructure solutions.}
      \resumeItemListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{Website Watcher --- Production Web Archiver} $|$ \emph{Python, Flask, SQLite, Prometheus, Docker}}{}
          \resumeItemListStart
            \resumeItem{Built \textbf{automated monitoring pipeline} tracking 100+ sites every 2 hours with change detection, full-text search across 50K+ snapshots, and Prometheus metrics.}
            \resumeItem{Deployed with \textbf{Docker Compose} for zero-downtime operation, implementing health checks, log rotation, and automated alerting on content changes.}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
